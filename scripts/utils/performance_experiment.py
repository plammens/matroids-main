...
class PerformanceExperiment:
    ...
    - input_generator: Function used to generate (random) input data given
        the values for x and the fixed variables as keyword arguments. Should return
        a dictionary of keyword arguments to pass to each of the timer functions.
    ...
    input_generator: tp.Callable[..., InputData] = lambda **kwargs: kwargs
    ...
    def measure_performance(self) -> PerformanceMeasurements:
        ...
        for i, x_value in enumerate(
            ...
            for label, timer in self.timer_functions.items():
                ...
                for j in range(self.generated_inputs):
                    input_data = self.input_generator(**input_variables)
